...
function NewProjectPage() {
    ...
    useProtectedRoute_1.useProtectedRoute(setUser, { newProject: true }, "admin", setIsLoading);
    ...
    var handleSubmit = function (e) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            e.preventDefault();
            if (!adminHelpers_1.validateForm(formData, setErrors))
                return [2 /*return*/];
            setIsSubmitting(true);
            project_1.createProjectHook(formData, user, name_1.username, setShowSuccess, setIsSubmitting, router);
            return [2 /*return*/];
        });
    }); };
    return (React.createElement("div", null,
        React.createElement("div", { className: "mb-8" },
            React.createElement(link_1["default"], { href: "/admin/projects", className: "text-blue-600 hover:text-blue-800 inline-block mb-4" }, "\u2190 Back to Projects"),
            React.createElement("h1", { className: "text-4xl font-bold text-gray-900 mb-2" }, "Create New Project"),
            React.createElement("p", { className: "text-gray-600 text-lg" }, "Setup a new project \u2014 add employees later")),
